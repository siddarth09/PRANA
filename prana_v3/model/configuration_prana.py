"""
PRANA v3 Configuration
======================
Flow-matching action prediction with correlated noise + DINOv2 vision.
...
Key design choices:
  ...
  - DINOv2 ViT-S/14 frozen backbone (384 dim, 256 tokens per camera)
...
@PreTrainedConfig.register_subclass("prana_v3")
@dataclass
